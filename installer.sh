...
echo "Do you want to run the web based Dashboard? (Y/n): "
RUNDASHBOARD=$(echo "$RUNDASHBOARD" | tr '[:upper:]' '[:lower:]')
RUNDASHBOARD="y"

if [ "$PREVIOUS_PASSWORD" != "none" ]; then
  echo "Do you want to change the password for the Dashboard? (y/N): "
...
while :; do
  echo "Enter the port (1025-65536) to access the web based Dashboard (default $DASHPORT_DEFAULT): "
...
while :; do
  echo "If you wish to set an explicit external IP, enter an IPv4 address (default=$EXTERNALIP_DEFAULT): "
...
while :; do
  echo "If you wish to set an explicit internal IP, enter an IPv4 address (default=$INTERNALIP_DEFAULT): "
...
while :; do
  ...
  echo "This allows p2p communication between nodes. Enter the first port (1025-65536) for p2p communication (default $SHMEXT_DEFAULT): "
  ...
  echo "Enter the second port (1025-65536) for p2p communication (default $SHMINT_DEFAULT): "
...
EXT_IP=${EXTERNALIP}
INT_IP=${INTERNALIP}
EXISTING_ARCHIVERS=[{"ip":"45.79.16.146","port":4000,"publicKey":"840e7b59a95d3c5f5044f4bc62ab9fa94bc107d391001141410983502e3cde63"},{"ip":"45.56.92.103","port":4000,"publicKey":"2db7c949632d26b87d7e7a5a4ad41c306f63ee972655121a37c5e4f52b00a542"},{"ip":"170.187.134.16","port":4000,"publicKey":"7af699dd711074eb96a8d1103e32b589e511613ebb0c6a789a9e8791b2b05f34"}]
