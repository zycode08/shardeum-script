...
while :; do
  echo "Enter the port (1025-65536) to access the web based Dashboard (default 8080): "
...
while :; do
  ...
  echo "This allows p2p communication between nodes. Enter the first port (1025-65536) for p2p communication (default 9001): "
  SHMEXT=${SHMEXT:-9001}
  ...
  echo "Enter the second port (1025-65536) for p2p communication (default 10001): "
  SHMINT=${SHMINT:-10001}
